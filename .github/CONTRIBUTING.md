...
pull request. We use Oxlint to enforce a consistent coding style, so having that set up in your editor of choice
is a great boon to your development process.

## Setup

You will need [Node.js](http://nodejs.org) **20.19.x or 22.13+**, and [npm](https://www.npmjs.com/).
...
4. Run `npm run lint` to ensure changes are valid
...
- [Oxlint](https://oxc.rs/docs/guide/usage/linter.html) for code-style
